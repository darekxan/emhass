...
class TestUtils(unittest.IsolatedAsyncioTestCase):
    ...
    def test_get_forecast_dates_dst_crossing(self, mock_ts_now):
        """
        Tests the forecast date generation on a day with a DST transition.
        """
        # 1. Define parameters for this specific test
        time_zone = pytz.timezone("Australia/Sydney")
        freq = 60  # in minutes
        ...
        expected_end = "2025-10-05T23:00:00"
        expected_range = (
            pd.date_range(start=expected_start, end=expected_end, freq=f"{freq}min", tz=time_zone)
            .tz_convert("utc")
            .round(f"{freq}min", ambiguous="infer", nonexistent="shift_forward")
    ...
    async def _assert_runtimeparams_dst_alignment(
        self,
        mock_ts_now,
        now_value,
        time_zone,
        ...
        mock_ts_now.return_value = now_value
        params = await TestUtils.get_test_params()
        params["retrieve_hass_conf"]["time_zone"] = time_zone
        params["retrieve_hass_conf"]["optimization_time_step"] = 60
        params["retrieve_hass_conf"]["method_ts_round"] = "nearest"
        params["optim_conf"]["delta_forecast_daily"] = 1
        params_json = orjson.dumps(params).decode("utf-8")
        retrieve_hass_conf, optim_conf, plant_conf = utils.get_yaml_parse(params_json, logger)
        params_out, _, optim_conf, _ = await utils.treat_runtimeparams(
            runtimeparams,
            params_json,
            retrieve_hass_conf,
            optim_conf,
        ...
        self.assertEqual(len(params_out["passed_data"]["pv_power_forecast"]), 24)
        self.assertEqual(len(params_out["passed_data"]["load_power_forecast"]), 24)
        self.assertEqual(len(params_out["passed_data"]["load_cost_forecast"]), 24)
        self.assertEqual(len(params_out["passed_data"]["prod_price_forecast"]), 24)
        self.assertEqual(params_out["passed_data"]["pv_power_forecast"][0], expected_first_value)
        self.assertEqual(params_out["passed_data"]["pv_power_forecast"][-1], expected_last_value)
    ...
    @patch("emhass.utils._get_now")
    async def test_treat_runtimeparams_dst_alignment_for_naive_mpc(self, mock_ts_now):
        """Runtime dict forecasts should align with DST-adjusted naive MPC forecast dates."""
        runtimeparams = {
            "prediction_horizon": 24,
            "pv_power_forecast": {
                "2026-03-29T00:00:00+01:00": 0.0,
                "2026-03-29T01:00:00+01:00": 1.0,
                "2026-03-29T03:00:00+02:00": 2.0,
                "2026-03-29T04:00:00+02:00": 3.0,
                "2026-03-29T05:00:00+02:00": 4.0,
                "2026-03-29T06:00:00+02:00": 5.0,
                "2026-03-29T07:00:00+02:00": 6.0,
                "2026-03-29T08:00:00+02:00": 7.0,
                "2026-03-29T09:00:00+02:00": 8.0,
                "2026-03-29T10:00:00+02:00": 9.0,
                "2026-03-29T11:00:00+02:00": 10.0,
                "2026-03-29T12:00:00+02:00": 11.0,
                "2026-03-29T13:00:00+02:00": 12.0,
                "2026-03-29T14:00:00+02:00": 13.0,
                "2026-03-29T15:00:00+02:00": 14.0,
                "2026-03-29T16:00:00+02:00": 15.0,
                "2026-03-29T17:00:00+02:00": 16.0,
                "2026-03-29T18:00:00+02:00": 17.0,
                "2026-03-29T19:00:00+02:00": 18.0,
                "2026-03-29T20:00:00+02:00": 19.0,
                "2026-03-29T21:00:00+02:00": 20.0,
                "2026-03-29T22:00:00+02:00": 21.0,
                "2026-03-29T23:00:00+02:00": 22.0,
                "2026-03-30T00:00:00+02:00": 23.0,
            },
            "load_power_forecast": {
                "2026-03-29T00:00:00+01:00": 100.0,
                "2026-03-29T01:00:00+01:00": 101.0,
                "2026-03-29T03:00:00+02:00": 102.0,
                "2026-03-29T04:00:00+02:00": 103.0,
                "2026-03-29T05:00:00+02:00": 104.0,
                "2026-03-29T06:00:00+02:00": 105.0,
                "2026-03-29T07:00:00+02:00": 106.0,
                "2026-03-29T08:00:00+02:00": 107.0,
                "2026-03-29T09:00:00+02:00": 108.0,
                "2026-03-29T10:00:00+02:00": 109.0,
                "2026-03-29T11:00:00+02:00": 110.0,
                "2026-03-29T12:00:00+02:00": 111.0,
                "2026-03-29T13:00:00+02:00": 112.0,
                "2026-03-29T14:00:00+02:00": 113.0,
                "2026-03-29T15:00:00+02:00": 114.0,
                "2026-03-29T16:00:00+02:00": 115.0,
                "2026-03-29T17:00:00+02:00": 116.0,
                "2026-03-29T18:00:00+02:00": 117.0,
                "2026-03-29T19:00:00+02:00": 118.0,
                "2026-03-29T20:00:00+02:00": 119.0,
                "2026-03-29T21:00:00+02:00": 120.0,
                "2026-03-29T22:00:00+02:00": 121.0,
                "2026-03-29T23:00:00+02:00": 122.0,
                "2026-03-30T00:00:00+02:00": 123.0,
            },
            "load_cost_forecast": {
                "2026-03-29T00:00:00+01:00": 0.2,
                "2026-03-29T01:00:00+01:00": 0.201,
                "2026-03-29T03:00:00+02:00": 0.202,
                "2026-03-29T04:00:00+02:00": 0.203,
                "2026-03-29T05:00:00+02:00": 0.204,
                "2026-03-29T06:00:00+02:00": 0.205,
                "2026-03-29T07:00:00+02:00": 0.206,
                "2026-03-29T08:00:00+02:00": 0.207,
                "2026-03-29T09:00:00+02:00": 0.208,
                "2026-03-29T10:00:00+02:00": 0.209,
                "2026-03-29T11:00:00+02:00": 0.21,
                "2026-03-29T12:00:00+02:00": 0.211,
                "2026-03-29T13:00:00+02:00": 0.212,
                "2026-03-29T14:00:00+02:00": 0.213,
                "2026-03-29T15:00:00+02:00": 0.214,
                "2026-03-29T16:00:00+02:00": 0.215,
                "2026-03-29T17:00:00+02:00": 0.216,
                "2026-03-29T18:00:00+02:00": 0.217,
                "2026-03-29T19:00:00+02:00": 0.218,
                "2026-03-29T20:00:00+02:00": 0.219,
                "2026-03-29T21:00:00+02:00": 0.22,
                "2026-03-29T22:00:00+02:00": 0.221,
                "2026-03-29T23:00:00+02:00": 0.222,
                "2026-03-30T00:00:00+02:00": 0.223,
            },
            "prod_price_forecast": {
                "2026-03-29T00:00:00+01:00": 0.1,
                "2026-03-29T01:00:00+01:00": 0.101,
                "2026-03-29T03:00:00+02:00": 0.102,
                "2026-03-29T04:00:00+02:00": 0.103,
                "2026-03-29T05:00:00+02:00": 0.104,
                "2026-03-29T06:00:00+02:00": 0.105,
                "2026-03-29T07:00:00+02:00": 0.106,
                "2026-03-29T08:00:00+02:00": 0.107,
                "2026-03-29T09:00:00+02:00": 0.108,
                "2026-03-29T10:00:00+02:00": 0.109,
                "2026-03-29T11:00:00+02:00": 0.11,
                "2026-03-29T12:00:00+02:00": 0.111,
                "2026-03-29T13:00:00+02:00": 0.112,
                "2026-03-29T14:00:00+02:00": 0.113,
                "2026-03-29T15:00:00+02:00": 0.114,
                "2026-03-29T16:00:00+02:00": 0.115,
                "2026-03-29T17:00:00+02:00": 0.116,
                "2026-03-29T18:00:00+02:00": 0.117,
                "2026-03-29T19:00:00+02:00": 0.118,
                "2026-03-29T20:00:00+02:00": 0.119,
                "2026-03-29T21:00:00+02:00": 0.12,
                "2026-03-29T22:00:00+02:00": 0.121,
                "2026-03-29T23:00:00+02:00": 0.122,
                "2026-03-30T00:00:00+02:00": 0.123,
            },
        }
        await self._assert_runtimeparams_dst_alignment(
            mock_ts_now,
            datetime(2026, 3, 29, 0, 47, 17),
            "Europe/Warsaw",
            runtimeparams,
            1.0,
            23.0,
    ...
    @patch("emhass.utils._get_now")
    async def test_treat_runtimeparams_dst_fall_back_alignment_for_naive_mpc(self, mock_ts_now):
        """Runtime dict forecasts should align across backward DST transitions too."""
        runtimeparams = {
            "prediction_horizon": 24,
            "pv_power_forecast": {
                "2026-10-25T00:00:00+02:00": 0.0,
                "2026-10-25T01:00:00+02:00": 1.0,
                "2026-10-25T02:00:00+02:00": 2.0,
                "2026-10-25T02:00:00+01:00": 3.0,
                "2026-10-25T03:00:00+01:00": 4.0,
                "2026-10-25T04:00:00+01:00": 5.0,
                "2026-10-25T05:00:00+01:00": 6.0,
                "2026-10-25T06:00:00+01:00": 7.0,
                "2026-10-25T07:00:00+01:00": 8.0,
                "2026-10-25T08:00:00+01:00": 9.0,
                "2026-10-25T09:00:00+01:00": 10.0,
                "2026-10-25T10:00:00+01:00": 11.0,
                "2026-10-25T11:00:00+01:00": 12.0,
                "2026-10-25T12:00:00+01:00": 13.0,
                "2026-10-25T13:00:00+01:00": 14.0,
                "2026-10-25T14:00:00+01:00": 15.0,
                "2026-10-25T15:00:00+01:00": 16.0,
                "2026-10-25T16:00:00+01:00": 17.0,
                "2026-10-25T17:00:00+01:00": 18.0,
                "2026-10-25T18:00:00+01:00": 19.0,
                "2026-10-25T19:00:00+01:00": 20.0,
                "2026-10-25T20:00:00+01:00": 21.0,
                "2026-10-25T21:00:00+01:00": 22.0,
                "2026-10-25T22:00:00+01:00": 23.0,
            },
            "load_power_forecast": {
                "2026-10-25T00:00:00+02:00": 100.0,
                "2026-10-25T01:00:00+02:00": 101.0,
                "2026-10-25T02:00:00+02:00": 102.0,
                "2026-10-25T02:00:00+01:00": 103.0,
                "2026-10-25T03:00:00+01:00": 104.0,
                "2026-10-25T04:00:00+01:00": 105.0,
                "2026-10-25T05:00:00+01:00": 106.0,
                "2026-10-25T06:00:00+01:00": 107.0,
                "2026-10-25T07:00:00+01:00": 108.0,
                "2026-10-25T08:00:00+01:00": 109.0,
                "2026-10-25T09:00:00+01:00": 110.0,
                "2026-10-25T10:00:00+01:00": 111.0,
                "2026-10-25T11:00:00+01:00": 112.0,
                "2026-10-25T12:00:00+01:00": 113.0,
                "2026-10-25T13:00:00+01:00": 114.0,
                "2026-10-25T14:00:00+01:00": 115.0,
                "2026-10-25T15:00:00+01:00": 116.0,
                "2026-10-25T16:00:00+01:00": 117.0,
                "2026-10-25T17:00:00+01:00": 118.0,
                "2026-10-25T18:00:00+01:00": 119.0,
                "2026-10-25T19:00:00+01:00": 120.0,
                "2026-10-25T20:00:00+01:00": 121.0,
                "2026-10-25T21:00:00+01:00": 122.0,
                "2026-10-25T22:00:00+01:00": 123.0,
            },
            "load_cost_forecast": {
                "2026-10-25T00:00:00+02:00": 0.2,
                "2026-10-25T01:00:00+02:00": 0.201,
                "2026-10-25T02:00:00+02:00": 0.202,
                "2026-10-25T02:00:00+01:00": 0.203,
                "2026-10-25T03:00:00+01:00": 0.204,
                "2026-10-25T04:00:00+01:00": 0.205,
                "2026-10-25T05:00:00+01:00": 0.206,
                "2026-10-25T06:00:00+01:00": 0.207,
                "2026-10-25T07:00:00+01:00": 0.208,
                "2026-10-25T08:00:00+01:00": 0.209,
                "2026-10-25T09:00:00+01:00": 0.21,
                "2026-10-25T10:00:00+01:00": 0.211,
                "2026-10-25T11:00:00+01:00": 0.212,
                "2026-10-25T12:00:00+01:00": 0.213,
                "2026-10-25T13:00:00+01:00": 0.214,
                "2026-10-25T14:00:00+01:00": 0.215,
                "2026-10-25T15:00:00+01:00": 0.216,
                "2026-10-25T16:00:00+01:00": 0.217,
                "2026-10-25T17:00:00+01:00": 0.218,
                "2026-10-25T18:00:00+01:00": 0.219,
                "2026-10-25T19:00:00+01:00": 0.22,
                "2026-10-25T20:00:00+01:00": 0.221,
                "2026-10-25T21:00:00+01:00": 0.222,
                "2026-10-25T22:00:00+01:00": 0.223,
            },
            "prod_price_forecast": {
                "2026-10-25T00:00:00+02:00": 0.1,
                "2026-10-25T01:00:00+02:00": 0.101,
                "2026-10-25T02:00:00+02:00": 0.102,
                "2026-10-25T02:00:00+01:00": 0.103,
                "2026-10-25T03:00:00+01:00": 0.104,
                "2026-10-25T04:00:00+01:00": 0.105,
                "2026-10-25T05:00:00+01:00": 0.106,
                "2026-10-25T06:00:00+01:00": 0.107,
                "2026-10-25T07:00:00+01:00": 0.108,
                "2026-10-25T08:00:00+01:00": 0.109,
                "2026-10-25T09:00:00+01:00": 0.11,
                "2026-10-25T10:00:00+01:00": 0.111,
                "2026-10-25T11:00:00+01:00": 0.112,
                "2026-10-25T12:00:00+01:00": 0.113,
                "2026-10-25T13:00:00+01:00": 0.114,
                "2026-10-25T14:00:00+01:00": 0.115,
                "2026-10-25T15:00:00+01:00": 0.116,
                "2026-10-25T16:00:00+01:00": 0.117,
                "2026-10-25T17:00:00+01:00": 0.118,
                "2026-10-25T18:00:00+01:00": 0.119,
                "2026-10-25T19:00:00+01:00": 0.12,
                "2026-10-25T20:00:00+01:00": 0.121,
                "2026-10-25T21:00:00+01:00": 0.122,
                "2026-10-25T22:00:00+01:00": 0.123,
            },
        }
        await self._assert_runtimeparams_dst_alignment(
            mock_ts_now,
            datetime(2026, 10, 25, 0, 47, 17),
            "Europe/Warsaw",
            runtimeparams,
            1.0,
            23.0,

...
class TestUtils(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_treat_runtimeparams_dst_alignment_for_naive_mpc(self, mock_ts_now):
        ...
        mock_ts_now.return_value = datetime(2026, 3, 29, 0, 47, 17)
        params = await TestUtils.get_test_params()
        params["retrieve_hass_conf"]["time_zone"] = "Europe/Warsaw"
        ...
        self.assertEqual(params_out["passed_data"]["pv_power_forecast"][0], 1.0)
        self.assertEqual(params_out["passed_data"]["pv_power_forecast"][-1], 23.0)
